  ...
  module GmPlugin 
    ...
    class GMap
      ...
      def self.header(options = {})
        ...
        a = "<script src=\"http://maps.google.ru/maps?file=api&amp;v=2.x&amp;key=#{api_key}&amp;hl=#{options[:hl]}&amp;sensor=#{options[:sensor]}\" type=\"text/javascript\"></script>\n"
        ...
        a << "<script src=\"http://www.google.ru/uds/api?file=uds.js&amp;v=1.0\" type=\"text/javascript\"></script>" if options[:local_search]
        a << "<script src=\"http://www.google.ru/uds/solutions/localsearch/gmlocalsearch.js\" type=\"text/javascript\"></script>\n" if options[:local_search]
        a << "<style type=\"text/css\">@import url(\"http://www.google.ru/uds/css/gsearch.css\");@import url(\"http://www.google.ru/uds/solutions/localsearch/gmlocalsearch.css\");}</style>" if options[:local_search]
        a
      end
